...
const CACHE='rutas-cr-shell-v24';
const SHELL=['./','./index.html','./assets/css/app.css?v=24','./assets/js/core.js?v=24','./assets/js/app.js?v=24','./assets/carriers/manifest.json','./manifest.json','./assets/icon-192.png','./assets/icon-512.png'];
