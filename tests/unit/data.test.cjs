...
test('optional split schedule columns flow from AppSheet into the public contract',()=>{const s=source(),extra=['LV_Apertura_1','LV_Cierre_1','LV_Apertura_2','LV_Cierre_2','SAB_Apertura_1','SAB_Cierre_1'];s.TRANSPORTISTA[0].push(...extra);s.TRANSPORTISTA[1].push('08:00','12:00','13:00','17:00','08:00','12:00');s.TRANSPORTISTA[2].push('','','','','','');const t=D.build(s).transportistas[0];assert.deepEqual(extra.map(f=>t[f]),['08:00','12:00','13:00','17:00','08:00','12:00']);assert.equal(C.scheduleStatusAt(t,1,12*60+30).state,'lunch');});
